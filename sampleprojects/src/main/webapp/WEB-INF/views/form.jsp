				...
				<div class="card">
					<div class="card-body">
						...
						<form action="handleform" method="post">
							...
							<div class="form-group">
								<label for="exampleInputEmail"> YourDOB</label> <input name
								="date" type="text" class="form-control" id="exampleInputEmail"
									placeholder="dd/mm/yyyy" aria-describedby="email-help">
							</div>
							<div class="form-group">
